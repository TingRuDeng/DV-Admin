...
- [x] P1 串行：规划 FastAPI 角色服务测试拆分，明确夹具和职责边界
- [x] P2 串行：拆分共享角色与权限夹具到 `role_service_fixtures.py`
- [x] P3 串行：拆分查询测试到 `test_role_service_query.py`
- [x] P4 串行：拆分写操作测试到 `test_role_service_mutation.py`
- [x] P5 串行：拆分删除测试到 `test_role_service_delete.py`
- [x] P6 串行：拆分菜单权限测试到 `test_role_service_menu.py`
- [x] P7 串行：删除原 `test_role_service.py`
