...
# from connect import TtyLog, Log, Session, user_have_perm, get_group_user_perm, ExecLog
from juser.models import User
from jasset.models import Asset
from jperm.models import PermRole
from jlog.models import TtyLog, Log, ExecLog
from webserver.api import logger, get_object
from jperm.perm_api import gen_resource, user_have_perm, get_group_user_perm
# from jperm.ansible_api import MyRunner

from webserver.settings import IP, PORT
...
#                self.term.vim_data = ''
    ...
    def forward_outbound(self):
        self.log_file_f, self.log_time_f, self.log, _ = self.term.get_log()
        self.id = self.log.id
...
def main():
    ...
    server.bind(options.port, address=IP)
...
if __name__ == '__main__':
    ...
    tornado.options.define('log_file_prefix', default='./logs/access.log')
    tornado.options.parse_command_line()
