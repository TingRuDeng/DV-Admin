...
class OperationLogPageQuery(BaseSchema):
    ...
    object_type: str | None = Field(default=None, description="业务对象类型")
    object_id: str | None = Field(default=None, description="业务对象ID")
...
class OperationLogOut(TimestampSchema):
    ...
    object_type: str = Field(default="", description="业务对象类型")
    object_id: str = Field(default="", description="业务对象ID")
    query_params: str = Field(default="", description="查询参数")
    request_context: dict[str, Any] = Field(default_factory=dict, description="结构化请求上下文")
