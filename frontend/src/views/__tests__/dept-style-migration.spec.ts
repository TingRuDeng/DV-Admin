...
describe("system dept style migration", () => {
  it("uses PageShell, ProSearch, ProTable and extracted form drawer without minimal-* classes", () => {
    const source = readFileSync(resolve(process.cwd(), "src/views/system/dept/index.vue"), "utf8");
    const drawerSource = readFileSync(
      resolve(process.cwd(), "src/views/system/dept/components/DeptFormDrawer.vue"),
      "utf8"
    );
    ...
    expect(source).toContain("<DeptFormDrawer");
