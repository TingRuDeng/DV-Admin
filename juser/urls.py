...
from juser.views import (
    group_list, group_add, group_del, group_edit, user_list, user_detail, profile, portrait_list,
    user_add, change_info, user_edit, user_departure, portrait_userupload
)
