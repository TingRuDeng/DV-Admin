...
API_FIELD_CONTRACTS: tuple[FieldContract, ...] = (
    ...
    FieldContract(
        ...
        django_source="drf_admin.apps.system.serializers.batch_delete.BatchDeleteResultSerializer",
        fastapi_source="app.schemas.system_common.BatchDeleteResult",
    ),
)
...
ENDPOINT_FIELD_CONTRACTS: dict[str, str] = {
    ...
    "users_delete": "batch_delete_result",
    "users_delete_retry": "batch_delete_result",
    "roles_page": "roles_out",
    "roles_form": "roles_with_permissions",
    "roles_create": "roles_out",
    "roles_update": "roles_out",
    "roles_delete": "batch_delete_result",
    "roles_delete_retry": "batch_delete_result",
    ...
    "notices_delete": "batch_delete_result",
    "notices_delete_retry": "batch_delete_result",
