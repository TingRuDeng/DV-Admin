...
from jperm.views import (
    perm_role_list, perm_role_add, perm_role_edit, perm_role_delete, role_with_user,
    sys_email_list, sys_email_add, sys_email_del, sys_email_edit, sys_email_detail, sys_email_save,
    sys_email_send, user_passwd_list, passwd_update, passwd_update_self, get_menu_dict
)
